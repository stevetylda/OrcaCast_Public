...
export function InfoModal({
  ...
  return (
    <div
      className={`overlay${darkMode ? "" : " overlay--light"}`}
      onClick={onClose}
      role="presentation"
    >
      <section
        ...
        <div className="modal__body modal__body--info">
          <div className="modal__section">
            ...
            <p className="modal__lead">
              OrcaCast forecasts where orca sightings are more likely to be
              reported during the selected window.
            </p>
          </div>
          ...
          <div className="modal__section">
            ...
            <ul className="modal__bullets modal__bullets--info">
              <li>
                <strong>Heatmap (hex cells):</strong> hotter colors = higher
                likelihood within the same week.
              </li>
              <li>
                <strong>Points:</strong> reported sightings for the selected or
                prior week (optional overlay).
              </li>
              <li>
                <strong>Compare weeks:</strong> use the forecast period control
          ...
          <div className="modal__section">
            ...
            <details className="modal__sources">
              <summary className="modal__sourcesSummary">
                ...
                <span className="modal__sourcesPreview">
                  {attribution.sources.length} sources
                </span>
                <span
              ...
              <div className="modal__sourcesBody">
                <div className="modal__sourcesGrid">
                  ...
                  <div>
                    <div className="modal__sourcesGroupTitle">
                      Forecast and sightings context
                    </div>
                    <ul className="modal__sourceList">
                      {attribution.sources
          ...
          <div className="modal__stickyWarnings">
            <div className="modal__callout modal__callout--psa">
              <div className="modal__calloutRow">
                <span
                  className="material-symbols-rounded modal__calloutIcon"
                  aria-hidden="true"
                >
                  warning
                </span>
                <div className="modal__calloutText">
                  <strong>Responsible use:</strong> Follow local wildlife
                  guidance and keep a respectful distance.
                  <div className="modal__calloutText--detail">
                    OrcaCast is for education and planning — not navigation or
                    enforcement.
                  </div>
                  <div className="modal__calloutText--detail">
                    <strong>Not real-time:</strong> OrcaCast does not show live
                    whale locations — it’s a short-term forecast based on
                    reported sightings.
                  </div>
                </div>
              </div>
