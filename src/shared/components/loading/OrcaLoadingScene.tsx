export function OrcaLoadingScene() {
  return (
    <div className="loadingAnimation__scene loadingAnimation__scene--orca" aria-hidden="true">
      ...
      <div className="orcaLoadingScene__drift">
        <img className="orcaLoadingScene__pair" src="/images/loaders/orca-mother-calf.png" alt="" />
      </div>
