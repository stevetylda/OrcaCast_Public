const UPPER_WINDOWS = Array.from(
  { length: 22 },
  (_, index) => 214 + index * 25,
);
const LOWER_WINDOWS = Array.from(
  { length: 23 },
  (_, index) => 196 + index * 26,
);

export function FerryLoadingScene() {
  return (
    <div
      className="loadingAnimation__scene loadingAnimation__scene--ferry"
      aria-hidden="true"
    >
      ...
      <div className="ferryLoadingScene__ferryRoute">
        ...
        >
          ...
          <g
            className="ferryLoadingScene__waterMotion"
            fill="none"
            stroke="#0b3159"
            strokeWidth="5"
            strokeLinecap="round"
          ...
          <g
            className="ferryLoadingScene__wakeMotion"
            fill="none"
            stroke="#35c7c0"
            strokeWidth="10"
            strokeLinecap="round"
          ...
          <g className="ferryLoadingScene__ferryBob">
            ...
            <path
              d="M69 239h823c-8 22-27 42-53 56H126c-25-13-44-31-57-56Z"
              fill="#092c52"
              stroke="#0b3159"
              strokeWidth="6"
              strokeLinejoin="round"
            ...
            <path
              d="M302 77h139l-10 36H312l-10-36Z"
              fill="#31c6b8"
              stroke="#0b3159"
              strokeWidth="6"
              strokeLinejoin="round"
            ...
            <g className="ferryLoadingScene__flag">
              ...
              <path
                d="M842 122c24-9 31 12 58 3-10 20-28 20-58 8V122Z"
                fill="#ff6f61"
                stroke="#ef5a4d"
                strokeWidth="4"
                strokeLinejoin="round"
            ...
            >
              ...
              {Array.from({ length: 17 }, (_, index) => 145 + index * 38).map(
                (x) => (
