...
export function FerryLoadingScene() {
  return (
      <div className="loadingAnimation__scene loadingAnimation__scene--ferry" aria-hidden="true">
        <span className="ferryLoadingScene__sparkle ferryLoadingScene__sparkle--one" />
        <span className="ferryLoadingScene__sparkle ferryLoadingScene__sparkle--two" />
        <span className="ferryLoadingScene__sparkle ferryLoadingScene__sparkle--three" />

        <div className="ferryLoadingScene__ferryRoute">
          <svg
            className="ferryLoadingScene__ferry"
          ...
          >
            ...
            <g className="ferryLoadingScene__waterMotion" fill="none" stroke="#0b3159" strokeWidth="5" strokeLinecap="round">
            ...
            <g className="ferryLoadingScene__wakeMotion" fill="none" stroke="#35c7c0" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round">
              <path d="M820 272l38-17-12 18 42-13-17 20 43-7-26 21 48-3" />
              <path d="M828 287l28-5-13 14 42-7-23 18 43-7" opacity="0.7" />
            </g>

            <g className="ferryLoadingScene__ferryBob">
              <g className="ferryLoadingScene__smoke">
                <g className="ferryLoadingScene__smokePuff ferryLoadingScene__smokePuff--one">
                ...
                <g className="ferryLoadingScene__smokePuff ferryLoadingScene__smokePuff--two">
                ...
                <g className="ferryLoadingScene__smokePuff ferryLoadingScene__smokePuff--three">
              ...
              <g className="ferryLoadingScene__flag">
                <path d="M838 184V115" fill="none" stroke="#0b3159" strokeWidth="6" strokeLinecap="round" />
                <circle cx="838" cy="113" r="5" fill="#0b3159" />
                <path d="M842 122c24-9 31 12 58 3-10 20-28 20-58 8V122Z" fill="#ff6f61" stroke="#ef5a4d" strokeWidth="4" strokeLinejoin="round" />
              </g>
